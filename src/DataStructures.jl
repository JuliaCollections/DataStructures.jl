module DataStructures
    ...
    import Base: <, <=, ==, length, isempty, iterate,
                 ...
                 eachindex, keytype, valtype, minimum, maximum, size, iterate
    ...
    export MutableBinomialHeap, MutableBinomialHeapNode, push!, show, top, top_with_handle, minimum, union!, update!, delete!, HeapBoundsError, findNode
